...
Due to best practice security measures, any developer that works on this repo will need to create their own .env development and test files declaring the dev PGDATABASE as 'nc_new' and the test db as 'nc_news_test'
